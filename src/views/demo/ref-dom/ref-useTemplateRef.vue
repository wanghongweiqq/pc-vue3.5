<template>
  ...
  <p>模版template中给input定义属性ref：ref="inputRefUseTemplateRef"</p>
  <p>js中使用先定义一个随意的变量，其值为useTemplateRef方法的结果，useTemplateRef的入参为模版中ref的值：const inputRef = useTemplateRef('inputRefUseTemplateRef')，然后用该变量名执行相关的dom方法：inputRef.value.focus()</p>
