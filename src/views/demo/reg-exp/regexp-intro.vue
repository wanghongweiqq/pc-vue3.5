...
const duanyanFun = () => {
  ...
  const pattern5 = /(\d+)([$€])/g
  const result = content.replace(pattern5,(match,b1,b2) => {
...
const containFun = () => {
  ...
  console.log('贪婪匹配', text.match(pattern0))
  console.log('非贪婪匹配', text.match(pattern1))
  console.log('左右断言', text.match(pattern2))
}
</script>
